  ...
  return (
    <div className={style.sender}>
      ...
      <div className={style.sender_form}>
        ...
        <InputSelect labelName='Provincia' name='origin.province' value={props.provinceOrigin} onInputChange={props.onInputChange} list={locations} />
        <InputSelect labelName='Ciudad' name='origin.city' value={props.cityOrigin} onInputChange={props.onInputChange} list={locations} />
